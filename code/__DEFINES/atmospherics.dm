...
#define MAX_OUTPUT_PRESSURE 15000 //SKYRAT CHANGE, NEARLY TRIPLES MAX TRANSFER RATE.
/// (L/s) Maximum speed powered equipment can work at.
#define MAX_TRANSFER_RATE 800 //SKYRAT CHANGE, QUADRUPLES MAX TRANSFER RATE.
